...
final class LigneFraisHorsForfaitController extends AbstractController
{
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$ligneFraisHorsForfait->getId(), $request->getPayload()->getString('_token'))) {
